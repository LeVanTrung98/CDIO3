            ...
            <div id="right">
                <div id="content1">
                    <div class="top4">
                        <ul>
                            <li>
                                <?php echo '<a href="../view/viewTTCN_Admin.php?action=ttcnAdmin">THÔNG TIN CÁ NHÂN</a>';
                                ?>
                            </li>
                        </ul>
                    </div>
                ...
                <div id="content2">
                    <div class="top4">
                        <ul>
                            <li>
                                <?php echo '<a href="../controller/xuli.php?action=quanlybienban">QUẢN LÝ BIÊN BẢN</a>' ?>
                             </li>
                        </ul>
                    </div>
                </div>
                <div id="content3">
                    <div class="top4">
                        <ul>
                            <li>
                             <?php echo '<a href="../view/quanlytainan.php?action=tainanUser">QUẢN LÝ TAI NẠN</a>';
                             ?>
                             </li>
                        </ul>
                    </div>
                ...
                <div id="content4">
                    <div class="top4">
                        <ul>
                            <li>
                                <?php echo '<a href="../view/quanlytaikhoan.php?action=bienbanUser">THÔNG TIN BIÊN BẢN</a>' ?>
