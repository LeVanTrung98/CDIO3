    ...
    <div id="wrapper">
        <div id="header">
            ...
            <div id="menu2">
                <ul>
                    <li>
                        <?php echo '<a href="../view/trangchu_admin.php?action=trangchuAdmin"><img src="../public/icon/baseline_home_white_18dp.png"></a>' ?>
                    </li>
            ...
            <div id="right">
                <div id="content1_gioithieu">
                    <div class="top1_gioithieu">
                        <ul>
                            <li><a href="./quanlytaikhoan.html"><b>QUẢN LÝ BIÊN BẢN</b></a></li>
                        </ul>
                    </div>
                    
                    <form class="form-qltainan" action="../controller/xuli.php" method="POST">
                        <input type="hidden" name="action" value="bienban">
                        <p><?php echo isset($errtendangnhap)?$errtendangnhap:null; ?></p>
                        <input class="ip-qltainan"  type="text" name="tendangnhap" placeholder="Tên đăng nhập người vi phạm...">
                         <p><?php echo isset($errmaca)?$errmaca:null; ?></p>
                        <input class="ip-qltainan"  type="text" name="maca" placeholder="Mã công an viên...">
                        <p><?php echo isset($errthoigian)?$errthoigian:null; ?></p>
                        <input class="ip-qltainan"  type="date" name="thoigian">
                        <p><?php echo isset($errdiadiem)?$errdiadiem:null; ?></p>
                        <input class="ip-qltainan"  type="text" name="diadiem" placeholder="Địa điểm...">
                         <p><?php echo isset($errmavp)?$errmavp:null; ?></p>
                        <!-- <input class="ip-qltainan"  type="text" name="mavp" placeholder="Mã lỗi vi phạm..."> -->
                        <select name="mavp" id="" class="ip-qltainan">
                            <?php 
                                foreach ($show as $value) {
                                    echo $value;
                                   echo '<option value="'.$value['mavipham'].'">'.$value['tenvipham'].'</option>';
                                }
                             ?>
                        </select>
