        ...
        <div id="maincontent">
            ...
            <div id="right">
                <div id="content1">
                    <div class="top4">
                        <ul>
                            <li><a href="#"><b>THÔNG TIN CÁ NHÂN ADMIN</b></a></li>
                        </ul>
                        <form action="../controller/xuli.php" method="post">
                            <input type="hidden" name="action" value="TTCNAdmin">
                            <input type="submit" name="submit" value="Show">
                        </form>
                        <div class="bottom">
                            <p><small>Mã Công An:</small>
                                <?php echo isset($macongan)?$macongan:null; ?>
                            </p>
                            <p><small>Tên Công An:</small>
                                 <?php echo isset($tencongan)?$tencongan:null; ?>
                            </p>
                            ...
                            <p><small>Tổ Công Tác:</small>
                                <?php echo isset($tocongtac)?$tocongtac:null;
                                 ?>
                            </p>
                        </div>
                    </div>
