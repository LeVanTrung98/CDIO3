            ...
            <div id="right">
                <div id="content1_gioithieu">
                    ...
                    <form class="form-qltainan" action="../controller/xuli.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="action" value="quanlyxe1">
                        <p><?php echo isset($errmatainan) ? $errmatainan : null; ?></p>
                        <input class="ip-qltainan" type="text" name="tendangnhap" placeholder="Tên đăng nhập ..." value="<?php echo isset($tendangnhap)?$tendangnhap:null?>">
                        <input class="ip-submit" type="submit" value="Show" name="submit">
                    </form>
                    ...
                    <?php 
                        ...
                        if(empty($xe)){
                            ...
                            foreach ($xe as $key => $value) {
                                ...
                                echo '<a href="../controller/xuli.php?action=dexe">Delete</a>';
                                echo '<a href="../controller/xuli.php?action=upxe">Update</a>';
                                echo '</div>';
                                echo'<hr>';
                            }
                        }
