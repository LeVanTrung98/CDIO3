            ...
            <div id="right">
                <div id="content1_gioithieu">
                    <div class="top1_gioithieu">
                        <ul>
                            <li><a href="./quanlytainan.html"><b>QUẢN LÝ TAI NẠN</b></a></li>
                        </ul>
                    </div>
                    <div style="margin-top: 20px;margin-bottom: -5px;">
                        <span style="text-align:center;"><h2>THÔNG TIN TAI NẠN</h2></span>
                    </div>
                    <form class="form-qltainan" action="../controller/xuli.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="action" value="quanlytainan">
                        <p><?php echo isset($errmatainan) ? $errmatainan : null; ?></p>
                        <input class="ip-qltainan" type="text" name="matainan" placeholder="Mã tai nạn...">
                        <p><?php echo isset($errmacongan) ? $errmacongan : null; ?></p>
                        <input class="ip-qltainan" type="text" name="macongan" placeholder="Mã công an...">
                        <p><?php echo isset($errdiadiem) ? $errdiadiem : null; ?></p>
                        <input class="ip-qltainan" type="text" name="diadiem" placeholder="Địa điểm tai nạn...">
                        <p><?php echo isset($errimage) ? $errimage : null; ?></p>
                        <input type="file" name="hinh" >
                        <p><?php echo isset($errthongtin) ? $errthongtin : null; ?></p>
                        <textarea name="thongtin" id="" class="txtr-thongtin" cols="50" rows="20" placeholder="Ghi Chú..."></textarea>
