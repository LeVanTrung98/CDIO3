        ...
        <div id="header">
            <div id="menu1">
                ...
                <ul>
                    ...
                    <li><?php echo '<a href="../controller/xuli.php?action=login" class="ip">Đăng Nhập</a>' ?>
                    </li>
                    <li>
            ...
            <div id="menu2">
                <ul>
                    <li>
                        <?php echo '<a href="../view/trangchu_user.php?action=trangchuUser"><img src="../public/icon/baseline_home_white_18dp.png"></a>' ?>
                    </li>
        ...
        <div id="maincontent">
            <div id="left">
                <ul>
                    ...
                    <li><?php echo '<a href="../controller/xuli.php?action=viewBB">THÔNG TIN BIÊN BẢN</a>' ?></li>
                    <li>
            ...
            <div id="right">
                ...
                <div id="content2">
                    <div class="top4">
                        <ul>
                            <li><?php echo '<a href="../controller/xuli.php?action=ttxeUser">XEM THÔNG TIN XE</a>' ?></li>
                        </ul>
                    </div>
                </div>
                <div id="content3">
                    <div class="top4">
                        <ul>
                            <li><?php echo '<a href="">QUY ĐỊNH GIAO THÔNG</a>' ?></li>
                        </ul>
                    </div>
                </div>
                <div id="content4">
                ...
                <div id="content6">
                    <div class="top4">
                        <ul>
                            <li> <?php echo '<a href="../controller/xuli.php?action=viewluat">LUẬT GIAO THÔNG</a>' ?></li>
                        </ul>
                    </div>
                </div>
                <div id="content7">
                    <div class="top4">
                        <ul>
                            <li><?php echo '<a href="">XEM TIN TỨC</a>' ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
