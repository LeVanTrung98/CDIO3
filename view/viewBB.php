            ...
            <div id="left">
                <ul>
                   <li>
                    ...
                    <li><?php echo '<a href="../view/quydinhgiaothong.php?action=quydinhgiaothongUser">QUY ĐỊNH GIAO THÔNG</a>' ?>
                    </li>
                    <li><a href="./dethithu.html">ĐỀ THI THỬ</a></li>
                    <li>
                        <?php 
                            echo '<a href="../view/quanlytainan.php?action=tainanUser">THÔNG TIN TAI NẠN</a>';
                         ?>
                    </li>

                    <li><?php echo '<a href="../view/quanlytaikhoan.php?action=bienbanUser">THÔNG TIN BIÊN BẢN</a>' ?></li>
                    <li>
                        <?php echo '<a href="../controller/xuli.php?action=luatgiaothongUser">LUẬT GIAO THÔNG</a>' ?>
                    </li>
                    <li>
                        <?php echo '<a href="../controller/xuli.php?action=tintucUser">XEM TIN TỨC</a>' ?>
                    </li>
                    <li>
                        <?php echo '<a href="../controller/xuli.php?action=lythuyetUser">THI THỬ LÝ THUYẾT</a>' ?>
                    </li>
                </ul>
            </div>
            <div id="right">
                <div id="content1_gioithieu">
                    <div class="top1_gioithieu">
                        <ul>
                            <li><a href="./quanlyxe.html"><b>QUẢN LÝ XE</b></a></li>
                        </ul>
                    </div>
