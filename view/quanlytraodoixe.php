            ...
            <div id="right">
                <div id="content1_gioithieu">
                    <div class="top1_gioithieu">
                        <ul>
                            <li><a href="./quanlytaikhoan.html"><b>ĐĂNG KÝ TRAO ĐỔI XE</b></a></li>
                        </ul>
                    </div>
                   ...
                   <form class="form-qltainan" action="../controller/xuli.php" method="POST" enctype="multipart/form-data">
                        ...
                        <p><?php echo isset($errMaxe) ? $errMaxe : null; ?></p>
                        <input class="ip-qltainan" type="text" name="maxe" placeholder="Mã xe...">
                        <p><?php echo isset($errchucu) ? $errchucu : null; ?></p>
                        <input class="ip-qltainan" type="text" name="chucu" placeholder="Tên đăng nhap chủ cũ...">
                        <p><?php echo isset($errchumoi) ? $errchumoi : null; ?></p>
                        <input class="ip-qltainan" type="text" name="chumoi" placeholder="Tên đăng nhập chủ mới...">
                         <p><?php echo isset($errmaca) ? $errmaca : null; ?></p>
                        <input class="ip-qltainan" type="text" name="maca" placeholder="Mã công an...">
                         <p><?php echo isset($errngaydoi) ? $errngaydoi : null; ?></p>
                        <input class="ip-qltainan" type="date" name="ngaydoi" placeholder="Ngày đổi...">
