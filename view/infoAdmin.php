            ...
            <div id="right">
                <div id="content1_gioithieu">
                    ...
                    <form class="form-qltainan" action="../controller/xuli.php" method="POST">
                            <input type="hidden" name="action" value="infoAdmin">
                            <p>
                                <?php echo isset($errM)?$errM:null ?>
                            </p>
                            <input type="text" class="ip-qltainan" name="macongan" placeholder="Mã công an...">
                            <p>
                                <?php echo isset($errT)?$errT:null ?>
                            </p>
                            <input type="text" class="ip-qltainan" name="tencongan" placeholder="Tên công an viên...">
                            <p>
                                <?php echo isset($errTCT)?$errTCT:null ?>
                            </p>
                            <input type="text" class="ip-qltainan" name="tocongtac" placeholder="Tổ công tác...">
                            <p>
                                <?php echo isset($errD)?$errD:null ?>
                            </p>
                            <input type="text" class="ip-qltainan" name="diadiem" placeholder="Địa điểm...">
                            <p>
