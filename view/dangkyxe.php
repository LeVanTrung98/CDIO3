            ...
            <div id="right">
                <div id="content1_gioithieu">
                    <div class="top1_gioithieu">
                        <ul>
                            <li><a href="./quanlytaikhoan.html"><b>ĐĂNG KÝ XE</b></a></li>
                        </ul>
                    </div>
                    
                   <form action="../controller/xuli.php" method="post" class="form-qltainan">
                        <input type="hidden" name="action" value="dangkyxe1">
                        <p>
                            <?php echo isset($errT)?$errT:null; ?>
                        </p>
                        <input type="number" class="ip-qltainan" name="tendangnhap" placeholder="Tên đăng nhập...">
                        <p>
                            <?php echo isset($errTCX)?$errTCX:null; ?>
                        </p>
                        <input type="text" class="ip-qltainan" name="nhanhieu" placeholder="Nhãn hiệu xe...">
                        <p>
                            <?php echo isset($errM)?$errM:null; ?>
                        </p>
                        <input type="text" class="ip-qltainan" name="mauxe" placeholder="Màu xe...">
                        <p>
                            <?php echo isset($errD)?$errD:null; ?>
                        </p>
                        <input type="text" class="ip-qltainan" name="theloai" placeholder="Thể loại...">
                        <p>
                            <?php echo isset($errN)?$errN:null; ?>
                        </p>
                        <input type="text" class="ip-qltainan" name="loaixe" placeholder="Loại xe...">
                        
                        <p>
                            <?php echo isset($errSK)?$errSK:null; ?>
                        </p>
                        <input type="text" class="ip-qltainan" name="sokhung" placeholder="Số khung...">
                        <p>
                            <?php echo isset($errSM)?$errSM:null; ?>
                        </p>
                        <input type="text" name="somay" class="ip-qltainan" placeholder="Số máy...">
