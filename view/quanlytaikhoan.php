            ...
            <div id="left">
                <ul>
                    <li> <?php 
                         ...
                         ?></li>
                    <li><a href="./quanlyxe.html">QUẢN LÝ XE</a></li>
                    <li>
            ...
            <div id="right">
                <div id="content1_gioithieu">
                    ...
                    <form class="form-qltainan" action="../controller/xuli.php" method="POST">
                        ...
                        <input class="ip-qltainan"  type="text" name="tendangnhap" placeholder="Tên tài khoản">
                         <p><?php echo isset($errpass)?$errpass:null; ?></p>
                        <input class="ip-qltainan"  type="text" name="pass" placeholder="Mật khẩu...">
                        <p><?php echo isset($errquyen)?$errquyen:null; ?></p>
                        <div class="radio">
                            <input type="radio" name="quyen" value="1">
                            <label for="">User</label>
                            <input type="radio" name="quyen" value="2">
                            <label for="">Admin</label>
                            <input type="radio" name="quyen" value="3">
